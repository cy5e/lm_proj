...
class Experiment(object):
    def __init__(self, args, data):
        ...
        gan = GAN(batch_size=self.batch_size, input_x_i=self.input_x_i, input_x_j=self.input_x_j,
        ...
        self.summary, self.losses, self.graph_ops = gan.init_train()
        self.same_images = gan.sample_same_images()
...
if __name__=='__main__':
    ...
    data = dataset.LandmarkGANDataset(batch_size=batch_size, last_training_class_index=1000, reverse_channels=True,
                                       num_of_gpus=num_gpus, gen_batches=10)
    experiment = Experiment(args, data=data)
